    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center space-x-4">
                ...
                @auth
                    <a href="{{ route('scanner', 'example-reference') }}" class="px-3 py-2 text-sm font-medium text-gray-700 hover:text-blue-500">Scanner</a>
                    @if(auth()->user()->role === 'agent')
                        <a href="{{ route('agent.scan') }}" class="px-3 py-2 text-sm font-medium text-gray-700 hover:text-blue-500">Générer QR</a>
                    @endif
